 ...
 * This fragment is either contained in a {@link mapListActivity}
 * in two-pane mode (on tablets) or a {@link mapDetailActivity}
 * on handsets.
 */
public class mapDetailFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mItem != null) {
            ((TextView) rootView.findViewById(R.id.map_detail)).setText(mItem.details);
        }
